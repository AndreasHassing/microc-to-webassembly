...
% TODO: remember to talk about why only 1 page is allocated
...
Due to time constraints, I decided to go with the 2nd solution, but wanted to implement the 1st. See %TODO: reference to technical description: variables in memory
...
\subsection{}
% TODO missing a few pages here regarding decisions made while creating the compiler
